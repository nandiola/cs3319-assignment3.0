<?php
        ...
        echo "<h5>Enter customer</h5>";

        echo 'Customer first name: <input type="text" name="firstname"><br>';

        echo 'Customer last name name: <input type="text" name="lastname"><br>';

        echo 'Customer city: <input type="text" name="city_located"><br>';
